<template>
  ...
  <div class="mainhead">
    <h1 class="main-heading">
      <span class="main-heading-primary"> Add Card </span>
    </h1>
  </div>
  ...
  <div class="container">
    <div class='form'>
      ...
      <form action="">
        ...
        <div class='submit'>
          <button class="btn" style="color: ghostwhite;" @click.prevent="newCard" alt="Submit"> &#10004; </button>
        </div>
      </form>
    </div>
  </div>
...
export default {
  ...
  methods: {
    newCard() {
      if (this.formData.card_status == null || this.formData.card_title == null || this.formData.card_content == null || this.formData.card_deadline == null) {
        ...
        this.postCard('http://localhost:8080/api/user/list/card', data).then((response) => {
          if (response.ok) {
